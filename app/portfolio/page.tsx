        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-1">
            ...
            {projects.map((project, index) => (
              <div
                key={index}
                className="overflow-hidden bg-white rounded-lg shadow-lg border border-light-gray flex flex-col md:flex-row"
              >
                {/* Image Grid (2x2) */}
                <div className="grid grid-cols-2 grid-rows-2 w-full md:w-1/2 lg:w-2/5 xl:w-1/3">
                  ...
                  {[...Array(Math.max(0, 4 - project.images.length))].map(
                    (_, i) => (
                      <div
                        key={`placeholder-${i}`}
                        className="bg-light-gray aspect-square"
                      ></div>
                    )
                  )}
                </div>
                ...
                {/* Project Details */}
                <div className="flex flex-col p-6 w-full md:w-1/2 lg:w-3/5 xl:w-2/3">
